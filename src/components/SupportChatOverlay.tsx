  ...
  return (
    <div className="fixed bottom-32 right-6 z-[100] flex flex-col items-end gap-4 pointer-events-none">
      ...
      <button 
        ...
        className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xl transition-all active:scale-90 pointer-events-auto relative ${isOpen ? 'bg-slate-900 text-white' : 'bg-indigo-600 text-white shadow-indigo-200'}`}
      >
